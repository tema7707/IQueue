...
export class OrdersChartComponent implements AfterViewInit, OnDestroy, OnChanges {
  ...
  async updateOrdersChartOptions(ordersChartData: OrdersChart) {
    const options = this.option;
    const series = await this.getNewSeries(options.series, ordersChartData.linesData);
  ...
  async getNewSeries(series, linesData: Observable<number[][]>) {
    var dataL = await linesData.toPromise();
