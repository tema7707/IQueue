...
export class ProfitChartComponent implements AfterViewInit, OnDestroy, OnChanges {
  ...
  async updateProfitChartOptions(profitChartData: ProfitChart) {
    const options = this.options;
    const series = await this.getNewSeries(options.series, profitChartData.data);
  ...
  async getNewSeries(series, data: Observable<number[][]>) {
    var dataL = await data.toPromise();
