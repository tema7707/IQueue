...
export class ECommerceVisitorsStatisticsComponent implements AfterViewInit, OnDestroy {
  ...
  static singleton : ECommerceVisitorsStatisticsComponent;
  option: any = {};
  ...
  constructor(private theme: NbThemeService,
    ...
    ECommerceVisitorsStatisticsComponent.singleton = this;
  }

  getValue0() {
    return (this.value[1]) == 0 ? 0 : Math.round(this.value[0] / (this.value[1]) * 100);
  }
  getValue1() {
    return (this.value[1]) == 0 ? 0 : 100 - Math.round(this.value[0] / (this.value[1]) * 100);
  }
      ...
      series: [
        {
          ...
          data: [
            {
              value: this.value[1] == 0 ? 0 : 100 - Math.round(this.value[0] / (this.value[1]) * 100),
              name: ' ',
              label: {
                normal: {
                  position: 'center',
            ...
            {
              value: (this.value[1]) == 0 ? 0 : Math.round(this.value[0] / (this.value[1]) * 100),
              name: ' ',
              tooltip: {
                show: false,
              },
